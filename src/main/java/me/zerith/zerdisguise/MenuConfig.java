package me.zerith.zerdisguise;
  ...
  public class MenuConfig {
      ...
      public MenuConfig(ZerDisguise plugin) { this.plugin = plugin; }
      ...
      public String getRankMenuTitle() { return str("titles.rank-menu", "&8» &#CC88FF&lSeleccionar Rango &8«"); }
      ...
      public String       getRankSelectorName()     { return str("buttons.rank-selector.name",     "&#CC88FF&l✦ Seleccionar rango"); }
      public Material     getRankSelectorMaterial() { return mat("buttons.rank-selector.material", Material.BOOKSHELF); }
      public int          getRankSelectorSlot()     { return slot("buttons.rank-selector.slot",    11); }
      public List<String> getRankSelectorLore()     { return lore("buttons.rank-selector.lore"); }

      public String       getLabelName()     { return str("buttons.label.name",     "&#CC88FF&l✦ Jugadores en linea"); }
      ...
      public String   getPrevName()     { return str("buttons.prev-page.name",     "&e&l◄ Pagina anterior"); }
      ...
      public String   getNextName()     { return str("buttons.next-page.name",     "&e&lPagina siguiente ►"); }
      ...
      // ── Botones del menu de confirmacion ───────────────────────────
      ...
      // ── Botones del menu de seleccion de rango ─────────────────────
      public String       getRankMenuLabelName()     { return str("rank-menu.label.name",     "&#CC88FF&l✦ Selector de Rango Visual"); }
      public Material     getRankMenuLabelMaterial() { return mat("rank-menu.label.material", Material.CHEST); }
      public int          getRankMenuLabelSlot()     { return slot("rank-menu.label.slot",    13); }
      public List<String> getRankMenuLabelLore()     { return lore("rank-menu.label.lore"); }

      public String       getRankMenuBackName()     { return str("rank-menu.back.name",     "&c&l◄ Volver al menu"); }
      public Material     getRankMenuBackMaterial() { return mat("rank-menu.back.material", Material.ARROW); }
      public int          getRankMenuBackSlot()     { return slot("rank-menu.back.slot",    45); }
      public List<String> getRankMenuBackLore()     { return lore("rank-menu.back.lore"); }

      public List<String> getRankMenuItemLore()     { return lore("rank-menu.rank-item-lore"); }
      ...
      // ── Helpers ────────────────────────────────────────────────────
      private String str(String path, String def) { return menu.getString(path, def); }
