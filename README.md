...
[![Versión](https://img.shields.io/badge/versión-2.0.0-purple?style=for-the-badge)](https://github.com/Zerinho23/ZerDisguise/releases/latest)
...
La versión **2.0.0** trae un rediseño completo del menú con estilo de panel informativo oscuro, tooltips enriquecidos con bordes `┌─┤─┘`, caché de skins para evitar llamadas repetidas a Mojang, y validación mejorada de nombres.
...
| 🎨 **Skin por nombre** | Aplica la skin del nombre elegido directamente sin UUID intermedio |
...
| 🛡️ **Validación** | Los nombres deben cumplir el formato Minecraft (solo letras, números, _) |
...
- Validación de nombres en el chat (solo letras, números, guión bajo)
- Título y subtítulo al solicitar nombre por chat
- Prevención de drag en inventarios del plugin
- Evento de muerte movido a ChatListener
- Correcciones menores de robustez
